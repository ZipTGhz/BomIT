...
//		getContentPane().repaint();
		...
		switch(panelKey) {
			case MENU_PANEL:          p = panelManager.getPanel(MENU_PANEL); break;
			case GAME_SETTING_PANEL:  p = panelManager.getPanel(GAME_SETTING_PANEL); break;
			case GAME_PANEL:          p = panelManager.getPanel(GAME_PANEL); break;
			default: return;
		}
